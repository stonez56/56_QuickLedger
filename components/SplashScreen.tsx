  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center animate-pulse-slow">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-on-surface tracking-tight flex items-center justify-center gap-4">
        ...
        <p className="mt-1 text-on-surface-variant text-sm font-medium tracking-widest uppercase">
          56 QuickLedger
        </p>
      </div>
      </div>
